	...
	<div id="wrapper" class="container_12 clearfix">
		...
		<div id="quicknav" class="grid_12">
			...
			<a class="quicknavgrid_3 quicknav" href="<cms:editable name='box2_link' label='Link' group='box2_group' type='text'>about.html</cms:editable>">
					<h4 class="title "><cms:editable name='box2_title' label='Title' group='box2_group' type='text'>Learn about us</cms:editable></h4>
					<p><cms:editable name='box2_text' label='Text' group='box2_group' type='textarea'>Cras vestibulum lorem et dui mollis sed posuere leo semper.</cms:editable> </p>
			...
			<a class="quicknavgrid_3 quicknav" href="<cms:editable name='box3_link' label='Link' group='box3_group' type='text'>blog.html</cms:editable>">
					<h4 class="title "><cms:editable name='box3_title' label='Title' group='box3_group' type='text'>Read our blog</cms:editable></h4>
					<p><cms:editable name='box3_text' label='Text' group='box3_group' type='textarea'>Cras vestibulum lorem et dui mollis sed posuere leo semper.</cms:editable> </p>
			...
			<a class="quicknavgrid_3 quicknav lastelem" href="<cms:editable name='box4_link' label='Link' group='box4_group' type='text'>#</cms:editable>">
					<h4 class="title "><cms:editable name='box4_title' label='Title' group='box4_group' type='text'>Follow on Twitter</cms:editable></h4>
					<p><cms:editable name='box4_text' label='Text' group='box4_group' type='textarea'>Cras vestibulum lorem et dui mollis sed posuere leo semper.</cms:editable> </p>
